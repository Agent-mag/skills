...
**Dart Cli App Best Practices** is an installable Agent Mag skill bundle. It gives your coding agent a focused prompt, optional tool definitions, and lightweight configuration so it can perform this job consistently inside your workflow.
...
```bash
npx agentmag add skill dart-cli-app-best-practices
```
...
- **License:** Apache-2.0
- **Slug:** `dart-cli-app-best-practices`
