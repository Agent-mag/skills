...
**Firebase Firestore Enterprise Native Mode** is an installable Agent Mag skill bundle. It gives your coding agent a focused prompt, optional tool definitions, and lightweight configuration so it can perform this job consistently inside your workflow.
...
```bash
npx agentmag add skill firebase-firestore-enterprise-native-mode
```
...
- **License:** MIT
- **Slug:** `firebase-firestore-enterprise-native-mode`
